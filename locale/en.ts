export default {
  ...
  TECH_TEXT:
    "<strong>🧩 FRONTEND:</strong> React, React Native, Redux, Context API, ESLint, TypeScript, REST and GraphQL APIs.<br /><br /><strong>💥 BACKEND:</strong> Strapi, Nest.js, Firebase, Node.js andRuby on Rails.<br /><br /><strong>🏦 DATABASES:</strong> PostgreSQL, MySQL and MongoDB.<br /><br /><strong>⚙️ INFRASTRUCTURE:</strong> Amazon Web Services (AWS), S3, Docker, Compose, Nginx, Redis and Serverles.<br /><br /><strong>🛠 CI/CD:</strong> Github Actions, Gitlab CI/CD, Jenkins.",
